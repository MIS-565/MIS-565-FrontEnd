...
const Step3ConfirmCheckout = ({ onPrevious, onFinish }: { onPrevious: () => void; onFinish: () => void }) => {
  const { patronData, itemData, setCheckoutInfo, patronID, itemID, checkoutInfo, isCheckoutComplete, setIsCheckoutComplete, resetCheckout,} = useCheckout();
      ...
      <div className="container">
        <div className="form-section">
          ...
          <>
            ...
            <p>Ready to checkout '{itemData?.ITEMNAME}' for {patronData?.PATRONFName} {patronData?.PATRONLName}</p>
          ...
          <div className="button-container">
            <button className="back-button1" onClick={onPrevious}>Back</button>
            <button   
