...
const SearchPatron: React.FC = () => {
  ...
  const handleSearchPatron = async () => {
    ...
    try {
      // Fetch patron data
      const response = await fetch(`https://mis-565-front-end.vercel.app/patrons/${patronID}`, {
        method: "GET",
        headers: {
      ...
      if (response.ok) {
        ...
        const itemsResponse = await fetch(`https://mis-565-front-end.vercel.app/patrons/${patronID}/items`, {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
          },
